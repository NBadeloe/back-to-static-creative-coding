...
onMount(() => {
    gsap.to(".article-img2", {
        xPercent: -20,
			ease: "none",
			scrollTrigger: {
				trigger:".article-img1",
				start: "top 20%",
				end: "bottom 30%",
				scrub: true,
            markers : false
...
<html lang="en">
    ...
    <article class="article-section">
        ...
        <img class="article-img1" src=./assets/dorian-corey.webp alt="">
    </article>
    <article class="article-section2">
        ...
        <img class="article-img2" src=./assets/pepper-labeija.webp alt="">
    </article>
    <article class="article-section">
        <section class="article-text">
        ...
        <img class="article-img3" src=./assets/willi-ninja.webp alt="">
    </article>
     <!-- <article>
